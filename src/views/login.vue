<template>
  <div
    class="w-full min-h-[100vh] flex items-center justify-center"
    dir="rtl"
    style="
  ...
  >
    <div
      class="md:w-1/2 sm:w-1/1 py-5 px-4 flex shadow-lg rounded-xl flex-col items-center justify-center"
    >
      <img
        class="sm:w-[10px] md:w-[40px] w-[40px]"
        src="../assets/icons/IMG-20240511-WA0003-fotor-bg-remover-20240511164232.png"
        alt=""
      />
